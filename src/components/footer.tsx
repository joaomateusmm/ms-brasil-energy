...
export default function Footer() {
  ...
  // Classe utilitária extraída para não repetir código e manter o padrão em todos os links
  const linkHoverClass =
    "group relative inline-flex items-center transition-all duration-300 hover:translate-x-2 hover:text-emerald-500";
  const barHoverClass =
    "absolute -left-3 top-1/2 h-[80%] w-1 -translate-y-1/2 scale-y-0 bg-emerald-500 transition-transform duration-300 group-hover:scale-y-100";
            ...
            <ul className="font-montserrat flex flex-col gap-3 text-base font-medium text-black/80 lg:gap-2 lg:text-lg">
              <li>
                <Link href="/" className={linkHoverClass}>
                  <span className={barHoverClass}></span>
                  Home
                </Link>
              </li>
              <li>
                <Link href="/sobre-nos" className={linkHoverClass}>
                  <span className={barHoverClass}></span>
                  Sobre Nós
                </Link>
              </li>
              <li>
                <a
                  ...
                  className={`cursor-pointer ${linkHoverClass}`}
                >
                  <span className={barHoverClass}></span>
                  Projetos
                </a>
              ...
              <li>
                <Link href="/tipos-de-sistemas" className={linkHoverClass}>
                  <span className={barHoverClass}></span>
                  Tipos de Sistemas
                </Link>
              </li>
            ...
            <ul className="font-montserrat flex flex-col gap-3 text-base font-medium text-neutral-800 lg:gap-4 lg:text-lg">
              <li>
                <a
                  ...
                  className={`${linkHoverClass} gap-2`}
                >
                  <span className={barHoverClass}></span>
              ...
              <li>
                ...
                >
                  ...
                  <svg
                    viewBox="0 0 24 24"
                    className="h-5 w-5 shrink-0 fill-current text-neutral-800 transition-colors duration-300 group-hover:text-emerald-500"
